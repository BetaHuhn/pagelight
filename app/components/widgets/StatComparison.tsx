...
import type { StatComparisonProps as StatComparisonDataProps, StatComparisonSide } from "../../lib/articleTypes";
...
const Block = ({ data, barRef, isAccent, accent, accentDim }: { data: StatComparisonSide; barRef: React.RefObject<HTMLDivElement | null>; isAccent: boolean; accent: string; accentDim: string }) => (
...
export function StatComparison({ left, right, description, accent, accentDim }: StatComparisonProps) {
  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 0 }}>
        <Block data={left} barRef={leftRef} isAccent={false} accent={accent} accentDim={accentDim} />
