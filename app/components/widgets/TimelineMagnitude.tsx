              ...
              <div
                style={{
                  ...
                  backgroundImage: isFuture
                    ? `repeating-linear-gradient(45deg, ${C.muted}18 0, ${C.muted}18 3px, transparent 3px, transparent 8px)`
                    : "none",
          ...
          <div key={i} style={{ flex: 1, textAlign: "center" }}>
            <div
              style={{
                ...
                fontSize: 9,
                color: ev.type === "current" ? accent : C.muted,
          ...
          <div key={label} style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <div
              style={{
                ...
                height: 10,
                borderRadius: 2,
                background: dashed ? "transparent" : (color ?? "transparent"),
                border: dashed ? `1px dashed ${C.muted}` : "none",
              }}
            />
            <span
              style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: C.muted }}
            >
              {label}
            </span>
          </div>
