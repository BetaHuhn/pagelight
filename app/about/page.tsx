    ...
    <>
      ...
      >
        ...
        >
            ...
            {/* Hero */}
            <section style={{ maxWidth: 600, width: "100%", margin: 'auto', marginBottom: 10, textAlign: "center" }}>
                <p style={{
                ...
                <p style={{
                    ...
                    Paste a URL or article text, and Pagelight extracts key data points and narrative structure, then renders an editorial-style layout with visualizations woven throughout.
                </p>
            </section>
          ...
          <ContentSection title="Features" accent={ACCENT}>
            ...
            >
              {[
                {
                  icon: <IconChartHistogram key="v" size={17} style={{ display: "inline-block" }} />,
                ...
                >
                  ...
                  >
                    {icon}
                    <div style={{ fontFamily: "'Geist Mono', monospace", fontSize: 13 }}>{title}</div>
                  </div>
          ...
          <ContentSection title="How it works" accent={ACCENT}>
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                <p>
                    At its core, Pagelight uses the <a href="https://www.anthropic.com/claude/sonnet" target="_blank" style={{ color: ACCENT }}>Claude Sonnet 4.6</a> LLM to analyze the structure and content of an article, blog post or report. It identifies key data points, trends, and narrative elements, then picks pre-built visualizations that complement the text.
                </p>
                ...
                <p>Before using Pagelight you need to provide a <a href="https://platform.claude.com/settings/keys" target="_blank" style={{ color: ACCENT }}>Anthropic API key</a>. Your API key will be stored locally in your browser and is never sent to our servers or anyone else except Anthropic.</p>
            </div>
          </ContentSection>
          ...
          <ContentSection title="Why it was built" accent={ACCENT}>
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                <p>
                This started as a fun experiment: using AI to spice up long-form reading by pulling out the
                “interesting bits” and giving them a visual home. Articles are full of numbers, comparisons, and
                timelines — Pagelight tries to make those moments feel tangible.
                </p>
                <p>
                Initially built for personal use, I soon realized it could be useful for others too. It’s a way to make
                dense information more engaging and accessible, especially for people who are visual learners or just want a fresh way to experience content.
                </p>
            </div>
          </ContentSection>

          <ContentSection title="Creator behind Pagelight AI" accent={ACCENT} style={{ overflow: "hidden" }}>
            <div
              style={{
                borderRadius: 12,
                display: "flex",
            ...
            >
              ...
              <div style={{ flex: "1 1 280px", minWidth: 240, display: "flex", flexDirection: "column", gap: 10 }}>
                <div style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
                  <div style={{ color: C.white, fontWeight: 600 }}>Maximilian Schiller (BetaHuhn)</div>
                  {/* <div style={{ color: C.muted, fontWeight: 300 }}>Product Engineer</div> */}
                </div>

                <p>
                  I&apos;m a product engineer who loves working on open-source projects and building things on the internet. Currently I&apos;m exploring the intersection of AI and personal local-first apps and the interfaces around them.
                </p>
              ...
              <div style={{ position: "absolute", bottom: -30, right: -30 }}>
                <svg
                    ...
                    style={{ width: 120, height: 120, color: ACCENT, opacity: 0.75 }}
                    ><defs
                        ...
                        <rect
                            ...
                            height="8"
                            fill="#fcfffe"
                            mask="url(#hash_pattern_mask)"></rect>
                        </pattern><style></style></defs><path
